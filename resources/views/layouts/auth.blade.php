...
<body class="antialiased bg-gradient-to-t from-red-500 to-white dark:to-red-500 dark:from-gray-800">
    ...
    <div id="toast-bottom-right" x-data="{ showToast: true }" x-init="setTimeout(() => showToast = false, 3000)"
        ...
        <div id="toast-success" class="ring-1 ring-gray-200 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-white dark:ring-gray-500" role="alert">
            <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:text-white">
            ...
            <button @click="showToast = false" type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-500 dark:text-gray-300 dark:ring-gray-500 dark:hover:bg-gray-300" aria-label="Close">
    ...
    <div class="container px-6 mx-auto">
        <div class="flex flex-col text-center md:text-left md:flex-row h-screen justify-evenly md:items-center">
            <div class="flex flex-col w-full">
                <div>
                    <svg class="w-20 h-20 mx-auto md:float-left fill-stroke text-gray-800 dark:text-white"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
