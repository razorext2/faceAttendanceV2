	...
	<div class="mt-1 w-auto rounded-lg border border-gray-100 bg-white shadow-md dark:border-none dark:bg-gray-700"
		...
		<ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
			...
			@if ($delete['show'])
				<li>
					<a
						class="block px-4 py-2 font-medium hover:bg-gray-100 dark:text-red-500 dark:hover:bg-red-300 dark:hover:text-red-700"
						id="delete-btn" data-id="{{ $id }}" href="javascript:void(0)">Delete</a>
				</li>
			@endif
		</ul>
	</div>
