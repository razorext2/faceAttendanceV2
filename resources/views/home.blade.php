...
<div class="relative flex min-h-screen flex-col justify-center overflow-hidden py-32" id="Home">
    ...
    <div class="relative z-10 grid grid-cols-1 mb-10 px-6" data-aos="fade-down">
        <div class="text-left md:text-center flex flex-col items-center justify-center h-full py-5 text-black">
            <h1 class="text-4xl font-bold mb-4">FaceID Attendance System</h1>
            <p class="text-lg">
            ...
            <p>Tekan tombol <span class="font-bold text-xl text-black">[-]</span> untuk melihat tutorial</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 h-auto lg:w-[900px]">
            <div class="video-container col-span-1 lg:col-span-2 text-center h-auto" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="inline-flex mt-3 w-full px-3 lg:px-0 md:px-3">
                    <button id="startButton" class="bg-blue-400 p-2 w-1/2 mr-2 rounded-lg font-bold text-white ring-1 ring-black hover:bg-blue-700">Start</button>
                    <button id="endAttendance" class="bg-red-400 p-2 w-1/2 rounded-lg font-bold text-white ring-1 ring-black hover:bg-red-700">Stop</button>
                </div>
                <div class="w-full h-auto mt-3 rounded-lg px-3 lg:px-0">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="relative flex flex-col gap-4 lg:gap-0 rounded-lg md:flex-row lg:flex-col w-full" data-aos="fade-right" data-aos-delay="100">
                        <div class="lg:object-fill w-full h-full rounded-lg lg:w-full md:rounded-lg">
                            ...
                            <canvas id="canvAttend" class="object-cover w-full h-full rounded-lg ring-1 ring-black absolute top-0 left-0"></canvas>
                        </div>
                    </div>

                    <div class="relative flex flex-col h-auto lg:justify-between p-4 leading-normal ring-1 ring-black rounded-lg w-full" data-aos="fade-left" data-aos-delay="100">
