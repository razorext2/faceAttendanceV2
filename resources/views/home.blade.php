...
<div class="relative flex min-h-screen flex-col justify-center overflow-hidden md:py-12 lg:py-32" id="Home">
    ...
    <div class="relative z-10 md:grid md:grid-cols-1 mb-10 px-6 hidden" data-aos="fade-down">
        <div class="text-left md:text-center md:flex md:flex-col items-center justify-center h-full py-5 text-black hidden">
    ...
    <div id="Scan" class="relative bg-white/70 p-0 ring-1 ring-black lg:mx-auto lg:rounded-lg lg:p-4 dark:bg-gray-800/70 dark:ring-gray-500" data-aos="zoom-in-up" data-aos-delay="50">
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-4 h-auto lg:w-[900px]">
            <div class="video-container col-span-1 lg:col-span-2 text-center h-auto p-3 lg:p-0" data-aos="zoom-in" data-aos-delay="100">
                <video id="video" class="flex w-full h-60 md:h-auto lg:w-[640px] lg:h-[480px] p-0 rounded-lg object-cover ring-1 ring-black dark:ring-gray-500" autoplay style="background: url('assets/img/noCamera.webp') center center / cover no-repeat;" data-aos="zoom-in" data-aos-delay="100">
                </video>
                <canvas id="overlay" class="flex w-full h-60 md:h-auto lg:w-[640px] lg:h-[480px] absolute top-0 left-0 p-0 rounded-lg object-cover"></canvas>
                <div class="inline-flex mt-3 w-full lg:px-0">
                ...
                <div class="w-full h-auto mt-3 rounded-lg lg:px-0 dark:bg-gray-800 hidden lg:block">
            ...
            <div class="col-span-1 lg:col-span-1 px-3 pb-3 md:px-3 md:pb-3 lg:p-0" data-aos="zoom-in" data-aos-delay="100">
                <div class="p-2 ring-1 ring-black rounded-lg text-center dark:ring-gray-500 dark:bg-gray-800 mb-4" data-aos="fade-left" data-aos-delay="100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4">
                    ...
                    <div class="relative flex flex-col gap-4 lg:gap-0 rounded-lg md:flex-row lg:flex-col w-full" data-aos="fade-right" data-aos-delay="100">
                        <div class="lg:object-fill w-full h-full rounded-lg lg:w-full md:rounded-lg">
                            <img id="canvLogo" class="object-cover lg:object-fill w-full h-60 md:h-auto lg:h-full rounded-lg ring-1 ring-black dark:ring-gray-500" src="{{asset('assets/img/noImage.webp')}}" alt="">
                            <canvas id="canvAttend" class="object-cover w-full h-60 md:h-full lg:h-full rounded-lg ring-1 ring-black absolute top-0 left-0 dark:ring-gray-500"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="w-full h-auto rounded-lg lg:px-0 dark:bg-gray-800 lg:hidden md:col-span-2">
                        <div class="p-3 text-left ring-1 min-h-10 h-auto ring-black rounded-lg dark:ring-gray-500">
                            <p class="text-sm font-bold text-black dark:text-white">Log</p>
                            <hr class="bg-black my-2 dark:bg-gray-800">
                            <pre id="consoleOutput" class="max-h-32 overflow-y-auto scroll-smooth dark:text-white"></pre>
