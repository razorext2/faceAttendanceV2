			...
			<div class="grid h-auto grid-cols-1 lg:w-[900px] lg:grid-cols-3 lg:gap-4">
				<div class="video-container col-span-1 h-auto p-3 text-center lg:col-span-2 lg:p-0" data-aos="zoom-in"
					...
					<div class="mt-3 inline-flex w-full lg:px-0">
						<button
							class="dark:bg-blue-800 dark:hover:bg-blue-900 dark:text-white dark:ring-gray-500 mr-2 w-1/2 rounded-lg bg-blue-400 p-2 font-bold text-white ring-1 ring-black hover:bg-blue-700"
							id="startButton">Start</button>
						<button
							class="dark:bg-red-800 dark:hover:bg-red-900 dark:text-white dark:ring-gray-500 w-1/2 rounded-lg bg-red-400 p-2 font-bold text-white ring-1 ring-black hover:bg-red-700"
