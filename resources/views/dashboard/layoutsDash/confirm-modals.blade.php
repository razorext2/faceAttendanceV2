		...
		<div class="dark:bg-gray-700 dark:ring-gray-700 relative rounded-lg bg-white shadow ring-1 ring-gray-300">
			...
			<div class="dark:border-gray-600 flex items-center space-x-2 rounded-b border-t border-gray-200 p-6">
				...
				<form id="confirmForm" method="POST" action="">
					...
					@method('put')
					<button
						class="dark:bg-green-800 dark:hover:bg-green-900 dark:focus:ring-green-900 rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300"
						type="submit">
