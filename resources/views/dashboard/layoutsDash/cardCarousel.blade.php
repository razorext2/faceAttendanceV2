<div class="inline-block scroll-ml-6 snap-start">
    <div class="overflow-hidden rounded-xl shadow bg-gray-50">
        <div class="group relative flex cursor-pointer after:shadow-lg after:shadow-black">
            <div class="relative -left-16 top-0 z-10 w-96 rounded-xl bg-[#3d348b] px-5 py-8 text-base font-semibold transition-all duration-700 group-hover:-left-3">
            ...
            <div class="absolute h-full -right-0 top-0 z-20 flex w-96 flex-col gap-5 self-end rounded-xl border-none bg-[#7678ed] px-5 py-8 text-base font-semibold transition-all duration-700 group-hover:-right-14 group-hover:w-64 group-hover:rounded-3xl">
