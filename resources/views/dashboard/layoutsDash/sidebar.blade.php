...
<aside
	...
	<div class="relative mt-3 max-h-[87.5%] overflow-y-auto p-5">
		<ul class="space-y-2 font-medium">
			...
			<li>
				<a
					class="{{ Route::currentRouteName() == 'collect.index' || Route::currentRouteName() == 'collect.create' || Route::currentRouteName() == 'collect.edit' ? 'text-red-600 font-bold bg-gray-100 dark:bg-[#18181b]' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-transparent hover:text-red-600' }} group flex items-center rounded-xl p-2"
					href="{{ route('collect.index') }}" role="menuitem">
					<svg
						class="fi-sidebar-item-icon {{ Route::currentRouteName() == 'collect.index' || Route::currentRouteName() == 'collect.create' || Route::currentRouteName() == 'collect.edit' ? 'stroke-red-600' : 'stroke-gray-400' }} h-6 w-6 text-gray-400 group-hover:stroke-red-600"
