	...
	<div class="relative mt-3 max-h-[87.5%] overflow-y-auto p-5">
		<ul class="space-y-2 font-medium">
			...
			@can('collect-list')
				<li>
					<a
						class="{{ Route::is('collect.*') ? 'text-red-600 font-bold bg-gray-100 dark:bg-[#18181b]' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-transparent hover:text-red-600' }} group flex items-center rounded-xl p-2"
						href="{{ route('collect.index') }}" role="menuitem">
						<svg
							class="fi-sidebar-item-icon {{ Route::is('collect.*') ? 'stroke-red-600' : 'stroke-gray-400' }} h-6 w-6 text-gray-400 group-hover:stroke-red-600"
						...
						<span class="ms-3 flex-1 whitespace-nowrap text-sm">Laporan Kolektor</span>
					</a>
				</li>
			@endcan
			...
			@can('capture')
				<li>
					<a
						class="{{ Route::is('capture.*') ? 'text-red-600 font-bold bg-gray-100 dark:bg-[#18181b]' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-transparent hover:text-red-600' }} group flex items-center rounded-xl p-2"
						href="{{ route('capture.index') }}" role="menuitem">
						<svg
							class="fi-sidebar-item-icon {{ Route::is('capture.*') ? 'stroke-red-600' : 'stroke-gray-400' }} h-6 w-6 text-gray-400 group-hover:stroke-red-600"
							viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
							<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
							<g id="SVGRepo_iconCarrier">
						...
						@can('users-list')
							<li>
								<a
									...
									<svg
										class="fi-sidebar-item-icon {{ Route::is('users.*') ? 'stroke-red-600' : 'stroke-gray-400' }} h-6 w-6 group-hover:stroke-red-600"
										viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
										<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
										<g id="SVGRepo_iconCarrier">
						...
						@can('permissions-list')
							<li>
								<a
									...
									<svg
										class="fi-sidebar-item-icon {{ Route::is('permissions.*') ? 'stroke-red-600' : 'stroke-gray-400' }} h-6 w-6 group-hover:stroke-red-600"
										viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
										<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
										<g id="SVGRepo_iconCarrier">
