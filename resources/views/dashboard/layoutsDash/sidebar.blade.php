<!-- Sidebar Navigation -->
<aside id="logo-sidebar" class="shadow-sm fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('attendanceIn.view') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Masuk</a>
                    </li>
                    <li>
                        <a href="{{ route('attendanceOut.view') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Keluar</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="{{ route('dashboard.pegawai') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            <li>
                <a href="{{ route('dashboard.jabatan') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
