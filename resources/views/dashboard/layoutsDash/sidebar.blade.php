        ...
        <ul class="space-y-2 font-medium">
            ...
            <li x-data="{ absensi: false }">
                <button @click="absensi = !absensi" type="button"
                    ...
                    <svg class="fi-sidebar-item-icon h-6 w-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <ul id="dropdown-example" x-show="absensi"
                    ...
                    <li>
                        <a href="{{ route('attendanceIn.view') }}" class="flex items-center w-full p-2 text-gray-900 rounded-lg pl-11 group hover:bg-gray-100">
                    ...
                    <li>
                        <a href="{{ route('attendanceOut.view') }}" class="flex items-center w-full p-2 text-gray-900 rounded-lg pl-11 group hover:bg-gray-100">
