                ...
                <div class="max-w-xl">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input name="tgl_lahir" id="tgl_lahir" datepicker datepicker-format="yyyy-mm-dd" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Select date">
                        </div>
