...
<form id="add-pegawai" action="{{ route('pegawai.add') }}">

</form>

<div class="grid grid-cols-1 gap-6 relative">
    <div class="absolute md:top-4 md:left-10 right-2 top-2">
        <button form="add-pegawai" class="px-2.5 py-2.5 ring-1 ring-green-700 hover:bg-green-300 rounded-lg flex flex-row">
