					...
					<div
						...
						<p class="text-navy-700 dark:text-white pt-1.5 text-base font-medium">
							@php
								...
								if ($status == 1) {
								    echo '<span class="dark:ring-gray-700 dark:bg-green-900 dark:text-green-300 rounded-full bg-green-100 px-4 py-1 text-sm font-medium text-green-800 ring-1 ring-gray-300"> Diterima </span>';
								} elseif ($status == 2) {
								    echo '<span class="dark:ring-gray-700 dark:bg-yellow-900 dark:text-yellow-300 rounded-full bg-yellow-100 px-4 py-1 text-sm font-medium text-yellow-800 ring-1 ring-gray-300"> Diajukan </span>';
								} elseif ($status == 3) {
								    echo '<span class="dark:ring-gray-700 dark:bg-red-900 dark:text-red-300 rounded-full bg-red-100 px-4 py-1 text-sm font-medium text-red-800 ring-1 ring-gray-300"> Ditolak </span>';
								} else {
								    echo '<span class="dark:ring-gray-700 dark:bg-red-900 dark:text-red-300 rounded-full bg-red-100 px-4 py-1 text-sm font-medium text-red-800 ring-1 ring-gray-300"> Dibatalkan </span>';
								}
							@endphp
						</p>
					</div>
