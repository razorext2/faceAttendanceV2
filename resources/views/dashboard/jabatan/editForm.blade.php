    ...
    <div class="p-4 sm:p-6 bg-gray-50 shadow-sm rounded-xl ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-500">
        <div class="max-w-xl">
            <header class="flex flex-row">
                <a href="{{ route('dashboard.jabatan') }}" class="mr-3 px-2.5 mb-4 md:px-4 py-2.5 align-middle ring-1 ring-red-700 hover:bg-red-300 rounded-lg flex flex-row dark:bg-red-800 dark:text-white dark:hover:bg-red-900 dark:ring-gray-500">
