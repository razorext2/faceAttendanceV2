            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 hover:text-black hover:font-semibold">
                    <td class="border-b">
                        ...
                        $tgl = \Carbon\Carbon::parse($data->jam_keluar)->format('Ymd_His');
                    ...
                    <td class="border-b">
                        ...
                        <span class="bg-red-100 text-red-800 text-xs ml-2 font-medium px-2.5 py-0.5 rounded-full ring-1 ring-gray-300 shadow-sm">Pulang Cepat</span>
                        @else
