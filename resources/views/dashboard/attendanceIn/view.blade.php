...
<div class="grid grid-cols-1 gap-6">
    <div class="flex items-center justify-center rounded-xl bg-gray-50 p-4 ring-1 ring-gray-200 shadow-sm dark:bg-gray-800 dark:ring-gray-500">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 hover:text-black dark:text-gray-300 dark:hover:bg-gray-700/50 dark:hover:text-white">
                    ...
                    <td>
                        ...
                        <span class="bg-red-100 text-red-800 text-xs ml-2 font-medium px-2.5 py-0.5 rounded-full ring-1 ring-gray-300 shadow-sm dark:bg-red-900 dark:text-white dark:ring-gray-500">Terlambat</span>
                        @else
