...
@section('content')
	<div class="grid grid-cols-1 gap-6">
		<div
			class="dark:bg-gray-800 dark:ring-gray-500 flex items-center justify-center rounded-xl bg-gray-50 p-4 shadow-sm ring-1 ring-gray-200">
						...
						<tr class="dark:text-gray-300 dark:hover:bg-gray-700/50 dark:hover:text-white hover:bg-gray-100 hover:text-black">
							...
							<td>
								...
								@if (
									...
									<span
										class="dark:bg-red-900 dark:text-white dark:ring-gray-500 ml-2 rounded-full bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 shadow-sm ring-1 ring-gray-300">Terlambat</span>
								@else
									<span
