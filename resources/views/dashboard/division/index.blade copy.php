    ...
    <div class="relative grid grid-cols-1 gap-6">
        <div class="absolute lg:top-3.5 lg:left-72 left-2 top-2">
            <button form="add-pegawai"
                class="px-5 md:px-8 py-2.5 ring-1 ring-green-700 hover:bg-green-300 rounded-lg flex flex-row dark:bg-green-800 dark:text-white dark:hover:bg-green-900 dark:ring-gray-500">
        ...
        <div
            class="flex items-center justify-center h-auto px-2 pt-16 pb-2 shadow-sm rounded-xl bg-gray-50 lg:p-4 ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-500">
