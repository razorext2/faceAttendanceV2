			...
			<div class="max-w-xl">
				...
				<form class="mt-4" action="{{ route('division.store') }}" method="POST">
					...
					<div class="mb-4 grid gap-6 sm:mb-5 sm:gap-6">
						<div class="w-full">
							<label class="dark:text-white mb-2 block text-sm font-medium text-gray-900" for="kode_divisi">Kode Divisi</label>
							<input
						...
						<div class="w-full">
							<label class="dark:text-white mb-2 block text-sm font-medium text-gray-900" for="divisi">Nama
								Divisi</label>
							<input
