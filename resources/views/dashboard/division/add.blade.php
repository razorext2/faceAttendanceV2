                    ...
                    <div class="grid gap-4 mb-4 sm:gap-6 sm:mb-5">
                        <div class="w-full">
                            <label for="kode_divisi"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Divisi</label>
                        ...
                        <div class="w-full">
                            <label for="divisi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                                Divisi</label>
