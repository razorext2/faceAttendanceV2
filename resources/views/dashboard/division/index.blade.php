...
@section('content')
    ...
    <div class="relative grid grid-cols-1 gap-6">
        ...
        <div class="flex items-center justify-center h-auto">
            <div
                class="grid w-full grid-cols-2 gap-2 p-2 shadow-sm md:gap-4 md:p-6 rounded-xl bg-gray-50 ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-500">
                <div class="grid grid-cols-2 col-span-2 gap-2 md:gap-4 md:col-span-2 lg:col-span-1">
                    <div>
                        <div class="relative">
