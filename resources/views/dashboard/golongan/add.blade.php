                ...
                <div class="w-full space-y-6 xl:col-span-2">
                    <div
                        ...
                        <div class="max-w-xl">
                            ...
                            <div class="grid gap-4 my-4 md:grid-cols-2 sm:gap-6">
                                <div class="w-full">
                            ...
                            <div id="jadwal" class="rounded-lg sm:my-4">
                                    ...
                                    <div class="w-full border-b border-b-gray-500">
                                        <div class="grid gap-2 py-4 sm:flex md:gap-4">
                                            ...
                                            <div class="w-20 sm:flex-none">
                                                <h3
                                                    class="mt-0 font-semibold text-gray-700 text-md dark:text-white md:mt-9">
                                                    {{ $day }}</h3>
                                            </div>

                                            <div class="w-full sm:flex-1">
                                                <label for="jam_masuk_{{ strtolower($day) }}"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam
                                                    Masuk</label>
                                                <input type="time" name="jam_masuk_{{ strtolower($day) }}"
                                            ...
                                            <div class="w-full sm:flex-1">
                                                <label for="jam_keluar_{{ strtolower($day) }}"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam
                                                    Keluar</label>
                                                <input type="time" name="jam_keluar_{{ strtolower($day) }}"
