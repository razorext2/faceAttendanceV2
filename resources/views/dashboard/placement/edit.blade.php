                    ...
                    <div class="max-w-xl">
                        ...
                        <div class="grid gap-4 mb-4 sm:gap-6 sm:mb-5">
                            <div class="w-full">
                                ...
                                <input type="text" name="kode_penempatan" id="kode_penempatan" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Kode Penempatan" required="" value="{{ $placement->kode_penempatan }}">
                            </div>
                            <div class="w-full">
                                <label for="penempatan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Penempatan</label>
                                <input type="text" name="penempatan" id="penempatan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Penempatan" required="" value="{{ old('penempatan', $placement->penempatan ?? '') }}">
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <select id="restrict_app" name="restrict_app" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                    ...
                                    <option value="y" @if($placement->restrict_app == 'y') selected @endif> Ya </option>
                                    <option value="t" @if($placement->restrict_app == 't') selected @endif> Tidak </option>
                                </select>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <textarea
                                    ...
                                    required>{{ old('alamat', $placement->alamat) }}</textarea>
                            </div>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <div class="flex mb-4">
                                    <div class="relative w-full">
                                        <input type="number" name="radius" id="radius" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter amount" value="{{ old('radius', $placement->radius ?? 0) }}" required />
                                    </div>
                                </div>
                                <div class="relative">
                                    <input id="radius-input" type="range" value="{{ old('radius', $placement->radius ?? 35) }}" min="10" max="150" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-white">
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="longitude" id="longitude" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="{{ old('radius', $placement->longitude) }}" required />
                                </div>
                                <div>
                                    <label for="latitude" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Latitude</label>
                                    <input type="text" name="latitude" id="latitude" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="{{ old('radius', default: $placement->latitude) }}" required />
                                </div>
                            </div>
